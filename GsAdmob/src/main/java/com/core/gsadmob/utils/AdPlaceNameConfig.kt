...
object AdPlaceNameConfig {
    ...
    val AD_PLACE_NAME_NATIVE = AdPlaceName(name = "Native", adUnitId = R.string.native_id, isReloadIfNeed = true, adGsType = AdGsType.NATIVE)
    val AD_PLACE_NAME_NATIVE_LANGUAGE = AdPlaceName(name = "Native language", adUnitId = R.string.native_language, isReloadIfNeed = true, adGsType = AdGsType.NATIVE)
